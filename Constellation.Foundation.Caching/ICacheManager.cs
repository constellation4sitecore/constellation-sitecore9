namespace Constellation.Foundation.Caching
{
	...
	/// This interface is meant to allow for Dependency Injection of a cache manager.
	/// </summary>
	/// <remarks>
	/// The CacheManager class provides the typical Add/Remove features of cache APIs, but 
	...
	public interface ICacheManager
	{
		...
		void Add(string key, object cachingData, object cacheTimer,
		...
		/// <param name="siteName">The site name</param>
		/// <param name="databaseName">The database name</param>
		/// <returns>Returns true if the data was removed from the cache or false if it wasn't or there was an error</returns>

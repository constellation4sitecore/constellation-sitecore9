...
namespace Constellation.Foundation.UrlFriendlyPageNames.Rules.Actions
{
	/// <summary>
		 ...
		 where T : global::Sitecore.Rules.RuleContext
	{
		...
		protected override void Execute(T ruleContext)
		{
			...
			{
				if (ItemNameManager.GetLocallyUniqueItemName(ruleContext.Item, this.IllegalCharacterRegEx, this.RemoveSpaces, this.ChangeCase, this.ReplaceDiacritics, out var name))
				{
